...
const TicDriveTextOrInput:React.FC<TicDriveTextOrInputProps> = ({value, setValue, placeholder = 'Insert value', title}) => {
    return (
        <View
        ...
        >
            ...
            value ? (
                ...
                <TicDriveInput placeholder={placeholder} customValue={value} onChange={(text) => setValue(text)} isRightIcon />
            )
            }
        </View>
    )
