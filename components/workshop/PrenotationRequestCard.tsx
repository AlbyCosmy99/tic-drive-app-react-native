                ...
                <View className="rounded-xl rounded-t w-4/5 p-2 mx-auto my-2">
                    <View>
                        ...
                        <View className="flex-row justify-between items-center mt-">
                            ...
                            <Text className="font-medium text-lg">Request: {number}/2024</Text>
                        </View>
                    </View>
            ...
            <View>
                <View className="flex-row mx-6 justify-evenly items-center">
                    <Pressable 
                        ...
                        style={{width: '48%'}}
                    >
                        <Text className='text-white text-center font-semibold text-lg'>Accetta</Text>
                    </Pressable>
                    <Pressable 
                        ...
                        style={{width: '48%'}}
                    >
                        <Text className='text-white text-center font-semibold text-lg'>Rifiuta</Text>
                    </Pressable>
                </View>
                <TouchableWithoutFeedback 
                    ...
                    onPress={() => {}}
                >
                    <Text className='text-white text-center font-semibold text-lg'>Proponi un altro orario</Text>
                </TouchableWithoutFeedback>
            </View>
            <HorizontalLine />
        </>
