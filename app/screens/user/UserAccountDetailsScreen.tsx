        ...
        <SafeAreaViewLayout tailwindCss="mx-3.5">
            <View className="flex-1">
                ...
                <View className="my-4">
                    ...
                    <IconTextPair
                        text="Notifications"
                        icon={<NotificationsIcon width={24} fill={Colors.light.ticText} />}
                ...
                <HorizontalLine color={Colors.light.lightGrey}/>
                <Text className="text-tic text-sm my-2.5 font-semibold">Delete account</Text>
            </View>
            <View className="mb-2.5">
                <Text className="text-center my-3.5">Terms of Service and Privacy Policy</Text>
                <TicDriveAuthButton
                    action="logout"
                />
            </View>
