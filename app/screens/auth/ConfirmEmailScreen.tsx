        ...
        <LinearGradientViewLayout>
            <SafeAreaViewLayout tailwindCss="mx-3.5">
                ...
                <View className="flex-1 justify-center items-center">
                    ...
                    <Pressable><Text className="underline text-md">Resend Confirmation Email</Text></Pressable>
                    <TicDriveButton text="I confirmed the email" customContainerStyle={{marginTop: 40}}/>
                </View>
