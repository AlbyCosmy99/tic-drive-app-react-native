        ...
        <View className="flex-1">
          ...
          <ScrollView>
            ...
            <View className="my-3">
              ...
              />
              <TouchableWithoutFeedback
                onPress={() => router.push('/(workshopTabs)/Requests')}
              >
                <Text className="self-end mr-12 mt-1 font-medium text-xl mb-1">
                  View All Requests
                </Text>
              </TouchableWithoutFeedback>
            </View>
            ...
            <View className="my-3">
              ...
              <HorizontalLine />
              <TouchableWithoutFeedback
                onPress={() => router.push('/(workshopTabs)/Account')}
              >
                <Text className="self-end mr-12 mt-3 font-medium text-xl mb-1">
                  View All Settings
                </Text>
              </TouchableWithoutFeedback>
            </View>
